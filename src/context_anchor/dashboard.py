...
<style>
:root{--blue:#2563eb;--green:#16a34a;--red:#dc2626;--amber:#d97706;--ink:#172033;--muted:#64748b;--line:#dce3ee;--bg:#f5f8fc;--card:#fff}
*{box-sizing:border-box} body{margin:0;font-family:Inter,system-ui,sans-serif;background:var(--bg);color:var(--ink)}
.shell{display:grid;grid-template-columns:230px 1fr;min-height:100vh}.side{background:#fff;border-right:1px solid var(--line);padding:24px 16px;position:sticky;top:0;height:100vh}
.brand{font-size:20px;font-weight:800;margin-bottom:28px}.brand small{display:block;font-size:12px;color:var(--muted);font-weight:500;margin-top:4px}
.nav button{width:100%;border:0;background:transparent;text-align:left;padding:12px;border-radius:10px;margin:3px 0;font-weight:650;color:#334155;cursor:pointer}.nav button.active,.nav button:hover{background:#eef5ff;color:var(--blue)}
.main{padding:24px 28px 50px;max-width:1500px}.top{display:flex;justify-content:space-between;align-items:center;margin-bottom:18px}.top h1{margin:0;font-size:27px}.top p{margin:5px 0;color:var(--muted)}
.grid{display:grid;gap:14px}.status-grid{grid-template-columns:repeat(4,minmax(0,1fr));margin-bottom:14px}.card{background:var(--card);border:1px solid var(--line);border-radius:15px;padding:17px;box-shadow:0 2px 10px rgba(15,23,42,.03)}
.status{display:flex;align-items:center;justify-content:space-between}.dot{width:10px;height:10px;border-radius:99px;background:#94a3b8;display:inline-block;margin-right:7px}.on .dot{background:var(--green)}.bad .dot{background:var(--red)}
.badge{font-size:12px;padding:5px 9px;border-radius:20px;background:#eef2f7}.on .badge{background:#eaf8ee;color:#15803d}.bad .badge{background:#feecec;color:#b91c1c}
.ops{grid-template-columns:1.05fr 1fr 1.1fr}.section-title{font-size:16px;font-weight:800;margin-bottom:13px}.buttons{display:grid;grid-template-columns:repeat(2,1fr);gap:9px}.btn{border:1px solid var(--line);background:#fff;border-radius:10px;padding:11px 12px;font-weight:750;cursor:pointer}.btn.primary{background:var(--blue);color:white;border-color:var(--blue)}.btn.green{background:#ecf9ef;color:#157a36;border-color:#cbeed4}.btn.red{background:#fff0f0;color:#b91c1c;border-color:#fecaca}.btn.amber{background:#fff7ed;color:#b45309;border-color:#fed7aa}
textarea,input{width:100%;border:1px solid #cdd6e4;border-radius:10px;padding:11px;font:inherit}textarea{min-height:112px;resize:vertical}.row{display:flex;gap:8px;margin-top:9px}.row .btn{flex:1}
.tasks{display:flex;flex-direction:column;gap:8px}.task{border:1px solid #e4e9f1;border-radius:10px;padding:10px}.task b{display:block;font-size:13px}.task small{color:var(--muted)}.task-status{float:right;font-size:11px;padding:3px 7px;background:#eef2ff;border-radius:10px;color:#334155}
.lower{grid-template-columns:1.1fr 1fr;margin-top:14px}.console{background:#0d1117;color:#c9d1d9;border-radius:10px;padding:12px;font:12px ui-monospace,monospace;white-space:pre-wrap;min-height:190px;max-height:310px;overflow:auto}
.switchline{display:flex;align-items:center;justify-content:space-between;padding:10px 0;border-bottom:1px solid #eef2f7}.switch{width:48px;height:26px;background:#cbd5e1;border-radius:30px;padding:3px;cursor:pointer}.switch span{display:block;width:20px;height:20px;background:white;border-radius:50%;transition:.15s}.switch.on{background:var(--blue)}.switch.on span{transform:translateX(22px)}
.learn{grid-template-columns:1.1fr 1fr;margin-top:14px}.explain{display:grid;grid-template-columns:repeat(2,1fr);gap:10px;margin-top:11px}.explain div{padding:12px;border-radius:10px;background:#f8fafc;border:1px solid #e5eaf2}.explain b{display:block;margin-bottom:5px}.muted{color:var(--muted);font-size:13px}.hidden{display:none!important}.diag{display:grid;grid-template-columns:repeat(3,1fr);gap:9px}.diag div{padding:10px;border:1px solid #e2e8f0;border-radius:9px;background:#fafcff}.message{position:fixed;right:25px;bottom:25px;background:#172033;color:#fff;padding:12px 16px;border-radius:10px;display:none;max-width:420px;z-index:20}
@media(max-width:1050px){.shell{grid-template-columns:1fr}.side{position:static;height:auto}.nav{display:flex;gap:5px;flex-wrap:wrap}.nav button{width:auto}.status-grid,.ops,.lower,.learn{grid-template-columns:1fr 1fr}.main{padding:18px}}@media(max-width:720px){.status-grid,.ops,.lower,.learn{grid-template-columns:1fr}.side{padding:14px}.main{padding:14px}}
</style>
</head>
